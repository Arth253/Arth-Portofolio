  ...
  return (
    <section id="about" className="max-w-5xl mx-auto px-6 py-20 bg-background">
      ...
      <p className="text-text-secondary leading-relaxed mb-2">
        ...
        {/* I’m a Software Engineer passionate about building scalable systems and applying ML/AI to real-world problems. I’m driven by challenging problems, optimisation, and continuously learning alongside people who push me to think differently.  */}
        {/* Mention where ive worked */}
        {/* What im working on */}
        {/* <br></br><br></br> */}
      </p>
      <p className="text-text-secondary leading-relaxed mb-4">
        Away from code, I captained my university's national Kho team to a 2nd place finish,
        led event planning and fundraising initatives for 1000+ students nationally
        and completed the Yorkshire Three Peaks despite flooded routes.
      </p>
    </section>
  )
}
